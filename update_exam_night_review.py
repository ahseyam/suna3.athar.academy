...
with open('/home/ubuntu/suna3.athar.academy/exam-night-review.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('/home/ubuntu/suna3.athar.academy/exam-night-review.html', 'w', encoding='utf-8') as f:
    f.write(content)
