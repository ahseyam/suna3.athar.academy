...
with open('/home/ubuntu/suna3.athar.academy/professional-license.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('/home/ubuntu/suna3.athar.academy/professional-license.html', 'w', encoding='utf-8') as f:
    f.write(content)
