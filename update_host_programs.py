...
with open('/home/ubuntu/suna3.athar.academy/host-programs.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('/home/ubuntu/suna3.athar.academy/host-programs.html', 'w', encoding='utf-8') as f:
    f.write(content)
